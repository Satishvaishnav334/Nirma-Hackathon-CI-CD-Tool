        ...
        <>
            <div className="flex justify-center h-screen items-center">
                <div className=" grid grid-cols-3 gap-4 p-4 rounded-lg  h-[50vh] w-[50vw]">
                    <div onClick={() => setShow(true)} className="h-[15vh] w-[15vw] bg-white hover:bg-zinc-300 hover:scale-95 transition-all  focus:outline-violet-500 active:bg-violet-700   cursor-pointer flex justify-center items-center rounded-lg shadow-2xl text-xl font-bold">
